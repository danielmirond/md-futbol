...
export interface SportConfig {
  ...
  revalidate?: number
  /** Emoji/icon fallback (used when logo file is missing) */
  icon: string
  /** Heading color accent — defaults to MD red */
  accent?: string
  /** Public path to a downloaded logo (`public/sports/{slug}.png`).
   *  Generated by `scripts/fetch-sport-logos.ts`. Optional. */
  logo?: string
}
...
export const SPORTS: Record<string, SportConfig> = {
  ...
  'college-football': {
    ...
    icon: '🏈',
    logo: '/sports/college-football.png',
    revalidate: 60,
  },
